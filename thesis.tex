...
However this paper will not go into detail about the semantic web, it will rather focus on how blockchain technologies can improve the web.\\\\
...
The term "smart contract" was first coined in 1994 by Nick Szabo. He already foresaw a marketplace in the digital world, built on these processes/contracts.\\
...
These are just some of the benefits and possible applications of using blockchain technology in the healthcare sector. There are already a significant number of scientific publications in this field, which could lead to a more rapid development of these technologies in the sector.
...
The book "Architecture for Blockchain Applications" \cite{babook} describes when the use of blockchain can be beneficial to a solution. In the book design patterns for blockchains and examples of applications for blockchains are presented. It also offers insights into the knowledge software developers need in order to build a blockchain application.\\

The paper "Wireless Blockchains: Trade-offs and Future Challenges" \cite{bcchallengesrelated} describes the challenges that wireless blockchains have to face. They go into detail about the performance that is needed to implement wireless blockchains. \\
...
\newpage
\chapter{Future work}
This paper can lead to a better understanding of the web 3.0, blockchain technologies and the challenges and opportunities thereof. A better definition of the next generation of the web can be developed to make it easier to understand. The presented challenges in this paper can lead to further improvements of the blockchain for general purposes. The energy cost of blockchain networks could be reduced and the security could be fortified against malicious attackers. This paper can spark new ideas for the applications of blockchain technologies in many different areas.
